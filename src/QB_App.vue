<!--
==============================================================================
ForestQB-V2 Main Application Component
==============================================================================
    ...
    <div class="container">
      ...
      <div class="row d-flex justify-content-center mt-100" style="margin-bottom: 20px">
        ...
        <div class="col-md-12">
          ...
          <div id="settingsModal" data-bs-backdrop="static" aria-hidden="true" aria-labelledby="settingsModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    <label class="form-label">SPARQL Endpoint</label>
                  ...
                  <span v-if="useLLMVersion">
                    <div class="d-inline-flex gap-1">
                      <div class="form-check form-switch">
                        <input v-model="llmEnabled" class="form-check-input" type="checkbox" role="switch"
                          id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault">Enable LLM for data
                          extraction</label>
                      </div>
                    ...
                    <div class="row" v-show="llmEnabled">
                      <div class="col">
                        <div class="mb-3">
                          <br>
                          <label class="form-label">Used Ontology

                            <div class="QBtooltip">
                              <img :src="'../images/info.svg'" />
                              <span class="QBtooltiptext">The indexing of this ontology helps in data extraction using
                                the
                                LLM.</span>
                            </div>
                          </label>
                          <textarea ref="ontologyRdfTriple" :value="ontologyRdfTriple" class="form-control"
                            rows="5"></textarea>
                        </div>
                        <p>Please don't click the below building button unless you have a diffrent onotlogy that you
                          want
                          to test. Building a new index will take time as the new RDF triples will be indexed on the
                          server and updated.</p>

                        <button v-if="!buildingIndex" class="btn btn-sm btn-warning" type="button"
                          @click="saveAndBuildOntology">
                          Save &amp; Build Ontology Index
                        </button>

                        <button v-else-if="buildingIndex" class="btn btn-sm btn-warningy" type="button" disabled>
                          <span class="spinner-border spinner-border-sm" aria-hidden="true"></span>
                          <span role="status">Building index...</span>
                        </button>
                      </div>
                    </div>
                    <hr />
          ...
          <!-- end of Sensors selection Modal -->
        </div>
        <div class="col"></div>
      </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      // ================
      // These are placeholders for the subject, predicate, and object parts of the triple pattern
      // They represent dynamic parts of the query to find sensor readings
  ...
  methods: {
    ...
    triplePatternUpdate() {
      console.log("triplePatternUpdate");
